        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultMessageHour = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredMessageHour = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedSessionData = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Birthdays_Contacts_ContactId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBirthdayMessage = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Birthdays_BirthDate",
                table: "Birthdays",
                column: "BirthDate");

            migrationBuilder.CreateIndex(
                name: "IX_Birthdays_ContactId",
                table: "Birthdays",
                column: "ContactId");

            migrationBuilder.CreateIndex(
                name: "IX_Birthdays_ContactId_IsEnabled",
                table: "Birthdays",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_ContactId_CreatedAt",
                table: "Messages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_UserId_Status_CreatedAt",
                table: "Messages",
                columns: new[] { "UserId", "Status", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_WhatsAppSessions_IsActive",
